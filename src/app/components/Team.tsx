...
const Team = ({ image }: { image: StaticImageData }) => {
    return (
        <>
            <div className="w-[316px] sm:w-[400px] xl:w-[316px] 2xl:w-[400px] h-full place-items-center hover:-translate-y-1 duration-500 cursor-pointer">
                <div className="w-full h-[231px] sm:h-[300px] xl:h-[231px] 2xl:h-[300px] rounded-md">
                    <Image src={image} alt="" className="rounded-md w-full h-full object-cover" />
                </div>
