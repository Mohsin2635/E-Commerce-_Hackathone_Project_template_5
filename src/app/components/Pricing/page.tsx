    ...
    return (
        <>
            <div className="overflow-hidden">
                ...
                <div className="w-full h-[2451px] sm:h-full bg-[#FAFAFA] place-items-center px-[2%]">
                    <div className="w-[330px] sm:w-full h-full py-[45px] space-y-[48px] place-items-center">
                        ...
                        <div className="h-[2112px] md:h-full gap-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center place-content-center">
                            <Pricing_card bg="bg-white" name="FREE" price="0" text="text-[#252B42]" pt="lg:pt-8" />
                            <Pricing_card bg="bg-[#252B42]" name="STANDARD" price="9.99" text="text-white" />
                            <Pricing_card bg="bg-white" name="PREMIUM" price="19.99" text="text-[#252B42]" pt="lg:pt-8" />
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full h-[1849px] md:h-full bg-white py-[80px] space-y-[80px] place-items-center lg:px-[12%] px-[2%]">
                    ...
                    <div className="w-[362px] h-[1344px] md:w-full md:h-full space-y-[10px] grid grid-cols-1 md:grid-cols-2 justify-between place-items-center">
                        <div className="w-full h-[220px] md:w-[491px] md:h-[159px] md:mb-10 py-4 px-4 md:px-10">
                            ...
                            <p className="text-[#737373] text-sm py-10 w-[313px] ">Met minim Mollie non desert
                    ...
                    <div className="w-full h-[60px] md:py-14 place-items-center">
